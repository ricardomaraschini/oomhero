...
pub trait Provider {
    ...
    fn path_for_oom_score(&self, pid: i32) -> String;
    fn path_for_oom_score_adj(&self, pid: i32) -> String;
    fn path_for_cmdline(&self, pid: i32) -> String;
}
...
impl Provider for SystemCGroups {
    ...
    // path_for_oom_score returns the path from where to read a process oom score.
    fn path_for_oom_score(&self, pid: i32) -> String {
        format!("/proc/{}/oom_score", pid)
    }

    // path_for_oom_score_adj returns the path from where to read a process oom score adjustment.
    fn path_for_oom_score_adj(&self, pid: i32) -> String {
        format!("/proc/{}/oom_score_adj", pid)
    }

    // path_for_cmdline returns the path from where to read a process command line.
    fn path_for_cmdline(&self, pid: i32) -> String {
