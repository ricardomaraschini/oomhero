...
## Usage
```bash
oomhero --warning 75 --critical 90 --loop-interval 200ms
...
--loop-interval <LOOP_INTERVAL>          How often scan all processes [default: 100ms]
--cooldown-interval <COOLDOWN_INTERVAL>  Interval between signals [default: 30s]
